...
from encontro.models import Encontro
from encontro.forms import EncontroForm
from encontro.tables import EncontroTable
from usuario.views.usuario_views import entrar

#######################################################################################################################################################################
# Cadastro de Encontro de Jovens ######################################################################################################################################
#######################################################################################################################################################################
...
#######################################################################################################################################################################
# Ativar/desativar Encontro de Jovens #################################################################################################################################
#######################################################################################################################################################################
@login_required(login_url=entrar)
def ativar_encontros(request, id):
    try:
        # Desativa todos os encontros
        encontros = Encontro.objects.all()
        for e in encontros:
            e.ativo = False
            e.save()

        # Recupera, ativa e salva o encontro escolhido.
        encontro = Encontro.objects.get(pk=id)
        encontro.ativo = True
        encontro.save()
