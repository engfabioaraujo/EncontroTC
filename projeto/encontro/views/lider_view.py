...
from encontro.models import Encontro, Lider
from encontro.forms import LiderForm
...
def cadastrar_lider(request):
    ...
    table_lider = LiderTable(Lider.objects.filter(encontro=encontro.pk).order_by("nome"))
        ...
        if form.is_valid():
            ...
            try:
                ...
                lider = Lider.objects.create(nome=nome, sobrenome=sobrenome, telefone=telefone, email=email, sexo=sexo,
                                             data_nascimento=data_nascimento, cargo=cargo,
                                             encontro=encontro, alt_usuario_nome=alt_usuario_nome, alt_usuario_data=alt_usuario_data)
