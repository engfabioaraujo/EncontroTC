...
from usuario.forms import RegistrarUsuarioForm, EditarUsuarioForm, CadastrarGruposForm
import projeto.views
...
def entrar(request):
	if request.user.is_authenticated():
		return redirect(projeto.views.index)
	else:
		...
		if form.is_valid():
			...
			try:
				...
				if senha == confirmar_senha:
				    ...
				    usuario_encontro = Perfil.objects.get(pk=user.pk)
